...
MYSQL_DB_NAME="rotternews"

# Modify the URL below to match your hiro base domain URL.
BASE_DOMAIN_URL="http://localhost/ScriptingAround/RotterNews2/www"
...
drush si -y rotternews --account-name=$ADMIN_USERNAME --account-pass=$ADMIN_PASSWORD --account-mail=$ADMIN_EMAIL --db-url=mysql://$MYSQL_USERNAME:$MYSQL_PASSWORD@$MYSQL_HOST/$MYSQL_DB_NAME --uri=$BASE_DOMAIN_URL --yes
